        ...
        const fetchRooms = async () => {
            ...
            try {
                const response = await fetch(
                    `${API_URL}/rooms?page=${page}&size=9&sort=${sort}`
                );
                const data: Collection<Room> = await response.json();
                ...
                <div className={styles.filterWrapper}>
                    <select
                        ...
                        onChange={(e) => {
                            ...
                            setSort(newSort);
                            setPage(0);
                            router.push(`?page=1&sort=${newSort}`, {scroll: false});
                        }}
                    >
                            ...
                            <div className={styles.cardContent}>
                                ...
                                <span className={styles.cardInfo}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                        <path stroke="#ededed" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 7v5l2.5-1.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/></svg>
            ...
            <div className={styles.buttonContainer}>
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-5.5 0 26 26">
                        <path fill="#ededed" fillRule="evenodd" d="m5.115 13 9.256-8.4c.831-.83.831-2.17 0-3a2.11 2.11 0 0 0-3.008 0L.596 11.36c-.45.45-.648 1.05-.611 1.64-.037.59.161 1.19.611 1.64l10.767 9.76a2.11 2.11 0 0 0 3.008 0c.831-.83.831-2.17 0-3L5.115 13"/>
                    </svg>
                </button>
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-5.5 0 26 26">
                        <path fill="#ededed" fillRule="evenodd" d="M14.404 11.36 3.637 1.6a2.11 2.11 0 0 0-3.008 0 2.117 2.117 0 0 0 0 3L9.885 13 .629 21.4a2.117 2.117 0 0 0 0 3c.83.84 2.177.84 3.008 0l10.767-9.76c.45-.45.648-1.05.611-1.64a2.115 2.115 0 0 0-.611-1.64"/>
                    </svg>
                </button>
            </div>
        </div>
